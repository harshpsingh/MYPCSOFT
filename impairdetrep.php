...
{
	$sql="select * from shipmentregister where branch='$_SESSION[branch]' and fy='$_SESSION[fy]' and importername='$_POST[importername]' and suppliername='$_POST[suppliername]' and overseasagentname='$_POST[overseasagentname]' and origincountry='$_POST[origincountry]' and docketdate between '$_POST[fromdate]' and '$_POST[todate]' ";	
}
$result=mysqli_query($connect,$sql);
 while($rows=mysqli_fetch_array($result)) 
 {
	...
	<button onclick="exportTableToExcel('tblData','impairrep')">Export Table Data To Excel File</button>
	</body>
	</body>
	</head>
	</html>
