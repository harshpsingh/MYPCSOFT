...
$sql="INSERT INTO cashreceipt(entrydate,voucherno,creditaccount,creditamount,debitaccount,debitamount,chequeno,narration,division) values('$_POST[entrydate]','$_POST[voucherno]','$_POST[creditaccount]','$_POST[creditamount]','$_POST[debitaccount]','$_POST[debitamount]','$_POST[chequeno]','$_POST[narration]','$_POST[division]')";
$result=mysqli_query($conn,$sql);
$vn=$_POST["vn"];
$vn=$vn+1;
$sql1="Update cashreceiptno set voucherno=$vn where branch='$_SESSION[branch]' and division='$_POST[division]'";
