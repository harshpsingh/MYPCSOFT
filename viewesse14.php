...
try {
	$sql = "SELECT *FROM shipmentregister where  destinationcountry= '$_POST[destinationcountry]'  and branch ='$_SESSION[branch]' and fy='$_SESSION[fy]'";
	$res = $pdo->query($sql); 
	if ($res->rowCount() > 0) { 
		echo "<table id='sr'>"; 
		echo "<tr>";
		...
		echo "<th>containerpickup</th>";
		echo "<th>handover</th>";
		
		echo "<th>package</th>";
		echo "<th>weight</th>";
		echo "<th>customseal</th>";
		
		echo "<th>shipperseal</th>";
		echo "<th>carrierseal</th>";
		...
		while ($row = $res->fetch()) { 
			echo "<tr>"; 
			 ...
			 echo "<td>".$row['shiplineaddress']."</td>"; 
			 ...
			 echo "<td>".$row['blno']."</td>"; 
			 echo "<td>".$row['bldate']."</td>"; 
			 echo "<td>".$row['hblno']."</td>"; 
			 echo "<td>".$row['hbldate']."</td>"; 
			 echo "<td>".$row['mblno']."</td>"; 
			 echo "<td>".$row['mbldate']."</td>";
			 ...
			 echo "<td>".$row['containerpickup']."</td>"; 
			 echo "<td>".$row['handover']."</td>"; 
			 echo "<td>".$row['package']."</td>"; 
			 echo "<td>".$row['weight']."</td>"; 
			 echo "<td>".$row['customseal']."</td>"; 
			 echo "<td>".$row['shipperseal']."</td>";	
              echo "<td>".$row['carrierseal']."</td>";	
...
$conn = new mysqli('localhost', 'root', '', 'exportsea') ;
 $result = $conn->query("SELECT *FROM shipmentregister where  destinationcountry ='$_POST[destinationcountry]' and branch ='$_SESSION[branch]'");
