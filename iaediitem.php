...
or die ('Cannot connect to db');
    ...
    $result = $conn->query("select * from iaediinvoice where jobno='$_POST[jobno]' and branch='$_SESSION[branch]' and fy='$_SESSION[fy]'");
...
<button type="submit" name="Saveitem" formaction="saveiaediitemdetails.php">Saveitem</button>
