...
$sql = "SELECT * from consignee where consigneename='$_POST[consigneename]'";
...
Consigneename<input type="text" name="consigneename" size="30" value="<?php echo $_POST["consigneename"]?>">
...
<button type="submit" name="update" formaction="modifyconsignee.php">Update</button>
</form>
</body>
</head>
</html>