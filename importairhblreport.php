...
$sql="select * from shipmentregister   where hawbblno !='' and branch='$_SESSION[branch]' and fy='$_SESSION[fy]'";
...
<button onclick="exportTableToExcel('tblData','impairhblreport')">Export Table Data To Excel File</button>
</body>
</head>
</html>
