...
$sql="select * from shipmentregister   where hblno !='' and branch='$_SESSION[branch]' and fy='$_SESSION[fy]'";
...
<button onclick="exportTableToExcel('tblData','expseahblreport')">Export Table Data To Excel File</button>
</body>
</head>
</html>
