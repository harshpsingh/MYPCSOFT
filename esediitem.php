...
<div class="col-md-3">		
<label>job no</label><input type="text" name="jobno" readonly value="<?php echo $_SESSION['jobno'];?>">
</div>
<div class="col-md-3">
...
<div class="row" style="position:relative; left:20;">
<div class="col-md-4">
<label>Invoice srno</label><?php

$conn = new mysqli('localhost', 'root', '', 'exportsea') 
or die ('Cannot connect to db');

    $result = $conn->query("select * from esediinvoice where jobno='$_SESSION[jobno]' and branch='$_SESSION[branch]' and fy='$_SESSION[fy]'");
...
<div class="row" style="position:relative; left:20;">
<div class="col-md-6">
<label>Currency name</label><?php

$conn = new mysqli('localhost', 'root', '', 'exportsea') 
or die ('Cannot connect to db');

    $result = $conn->query("select * from esediinvoice where jobno='$_SESSION[jobno]' and branch='$_SESSION[branch]'");
...
<div class="row" style="position:relative; left:20;">
<div class="col-md-6">
<label>scheme code</label><select name="schemecode" id="schemecode"  onChange="getschemedescription(this.value);">
<option> </option>
...
<button type="submit"  class="btn-primary" name="Saveitem" formaction="saveesediitemdetails.php">Saveitem</button>
<button type="submit"  class="btn-primary" name="profile" formaction="esedidet.php">ediprofile</button>


</form>
<iframe src="viewesediitemdet.php" width="800"height="300" style="background-color:white;" ></iframe>
</body>
</head>
</html>