...
<?php $dn=explode("/",$docketno);
	...
	<div class="four columns">
<label>Billno</label><input type="text"id="billnum" name="billno"value="<?php echo $br."/AI/S".$dno."/".$fy?>" >
</div>
<div class="four columns">
...
<button type="submit" name="save1" class="button-primary" formaction="saveinvoicedetailsia.php" >Save1</button>
</form>
<iframe name="frame1" src="viewiainvoice.php" width="600" height="200" style="background-color:#ffffff;"></iframe>
...
<button type="submit" name="save2"  class="button button-primary"formaction="saveinvoicechargeia.php">save2</button>
<button type="submit" name="print" class="button button-primary" formaction="printserviceinvoiceia.php">Print</button>
</form>
<iframe src="viewiainvoicechargedet.php" width="600" height="400"  style="background-color:#ffffff;"></iframe>
</body>
</head>
</html>
