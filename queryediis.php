...
<a href="isediprofile.php">edi profile</a>
<?php
session_start();
$conn1=mysqli_connect('localhost','root','','importsea');
...
try{
    $conn2 = new PDO("mysql:host=$servername;dbname=importsea", $username, $password);
...
<button type="submit" name="create" formaction="isedidet.php">isedidet</button>
