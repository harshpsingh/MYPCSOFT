...
function getdischargeportname(val) {
	$.ajax({
	type: "POST",
	url: "get_dischargeportname.php",
...
function getdestinationportname(val) {
	$.ajax({
	type: "POST",
	url: "get_destinationportname.php",
...
function getportcode2(val) {
	$.ajax({
	type: "POST",
	url: "get_portcode2.php",
	data:'destinationportname='+val,
	success: function(data){
		$("#destinationportcode").html(data);
	}
	});
}	
</script>
...
<div class="row">
<div class="col-md-4">
user name<input type="text" name="username" readonly value="<?php echo $_SESSION['username'];?>">
</div>
...
<div class="row">
<div class="col-md-6">
job no<input type="text" name="jobno" readonly value="<?php echo $_SESSION['jobno'];?>">
</div>
...
<div class="row">
<div class="col-md-6">
Gst State Name<select name="gststate" id="gststate">
<option></option>
</select>
</div>
<div class="col-md-6">
...
<div class="col-md-4">
ad code<select name="adcode" id="adcode">
<option></option>
</select>
</div>
</div><br>
...
<div class="row">
<div class="col-md-3">
Consigee name<select name="consigneename" id="consigneename" onChange="getconsigneeaddress(this.value);getconsigneecountry(this.value);">
<option> </option>
...
consignee address<select name="consigneeaddress" id="consigneeaddress" >
...
<div class="row">
<div class="col-md-6">
Consignee country<select name="consigneecountryname" id="consigneecountryname" onChange="getcode(this.value);">
<option></option>
...
<div class="col-md-6">
Consignee Country code<Select name="consigneecountrycode" id="consigneecountrycode">
<option><option>
</select>
</div>
</div><br>
<div class="row">
<div class="col-md-3">
Cha name<select name="chaname">
<option></option>
<option>Amrit Seair Express Pvt.Ltd</option>
<option>Amrit Freight Forwarders</option>
...
<div class="row">
<div class="col-md-6">
Discharge country<select name="dischargecountryname" id="dischargecountryname" onChange="getcode1(this.value);">
<option></option>
<?php foreach ($data1 as $row): ?>
    <option><?=$row["countryname"]?></option>
<?php endforeach ?>
...
<div class="col-md-6">
Discharge country code<select name="dischargecountrycode" id="dischargecountrycode" onChange="getdischargeportname(this.value);">
<option></option>
</select>
</div>
</div><br>
<div class="row">
<div class="col-md-6">
Discharge port<select name="dischargeportname" id="dischargeportname" OnChange="getportcode1(this.value);">
<option><option>

</select>
</div>
<div class="col-md-6">
Discharge portcode<select name="dischargeportcode" id="dischargeportcode">
<option></option>
</select>
</div>
</div><br>
<div class="row">
<div class="col-md-6">
Destination country<select name="destinationcountryname" id="destinationcountryname" onChange="getcode2(this.value);">
<option></option>
<?php foreach ($data1 as $row): ?>
    <option><?=$row["countryname"]?></option>
<?php endforeach ?>
...
<div class="col-md-3">
Destination country code<select name="destinationcountrycode" id="destinationcountrycode" onChange="getdestinationportname(this.value);">
<option></option>
</select>
</div>
</div>
<div class="row">
<div class="col-md-6">
Destination port<select name="destinationportname" id="destinationportname" OnChange="getportcode2(this.value);">
<option><option>

</select>
</div>
<div class="col-md-6">
Destination port code<select name="destinationportcode" id="destinationportcode">
<option></option>
</select>
</div>
</div><br>
...
<div class="col-md-3">
pack type<input type="text" name="packtype">
</div>
</div>
<div class="row">
<div class="col-md-6">
Container no<input type="text" name="containerno" maxlength="11" minlength="11">
</div>
<div class="col-md-6">
Container size<input type="text" name="containersize">
</div>
</div>
<div class="row">
<div class="col-md-6">
...
<div class="row">
<div class="col-md-6">
no of packets stuffed<input type="text" name="noofpacketsstufffed">
</div>
<div class="col-md-6">
...
<div class="row">
<div class="col-md-3">
Device id<input type="text" name="deviceid">
</div>
<div class="col-md-3">
Doc type<input type="text" name="doctype">
</div>
<div class="col-md-3">
Doc no<input type="text" name="docno">
</div>
<div class="col-md-3">


Marks no<input type="text" name="marksno" value="I/WE UNDERTAKE TO ABIDE BY FOREIGN EXCHANGE MANAGEMENT ACT, 1999, AS AMENDED FROM TIME;TO TIME, INCLUDING REALIZATION/REPATRIATION OF FOREIGN EXCHANGE TO FROM INDIA.WE INTEND TO CLAIM; REWARDS UNDER MERCHANDISE EXPORTS FROM INDIA SCHEME (MEIS)."><br>
