...
<button type="submit" class=" button button-primary" style="width: 200px; position:relative; left:360;"  name="exportsea" formaction="esshiprep.php">export sea report</button><br>
<br><br>
     ...
     <input type="submit" name="export" class="button button-primary"style="width: 200px; position:relative; left:360;" value="Export to excel" formaction="exportexcel.php" />
    </form>
</body>
</head>
</html>
