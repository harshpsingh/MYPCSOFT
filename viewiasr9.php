...
try {
	$sql ="SELECT *FROM shipmentregister where  docketno ='$_POST[docketno]'  or  importername= '$_POST[importername]' or  suppliername ='$_POST[suppliername]'   or hawbblno='$_POST[hawbblno]'    or origincountry='$_POST[origincountry]' or originport='$_POST[originport]' or destinationcountry='$_POST[destinationcountry]' or destinationport='$_POST[destinationport]' and branch ='$_SESSION[branch]' and fy='$_SESSION[fy]'";
	$res = $pdo->query($sql); 
	if ($res->rowCount() > 0) { 
		echo "<table id='sr'>"; 
		echo "<tr>";
