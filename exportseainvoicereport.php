...
$sql="select * from esserviceinvoice  where branch='$_SESSION[branch]' and fy='$_SESSION[fy]'";
...
$sql2="select sum(amount) as sumamount from esinvoicecharge where  docketno='$row[docketno]'";
...
<button onclick="exportTableToExcel('tblData','expseainvoicereport')">Export Table Data To Excel File</button>
</body>
</head>
</html>
