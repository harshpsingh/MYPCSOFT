...
<body>
<iframe src="viewairport.php" width=600" height="400"></iframe>
...
<button type="submit" name="add" formaction="saveairport.php">Add</button>
<button type="submit" name="modify" formaction="updateairport.php" >Modify</button>
<button type="submit" name="delete" formaction="deleteairport.php">Delete</button>
</form>
</body>
</html>