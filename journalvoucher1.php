...
<button><a href="journalvouchers.php">Journalvoucher</a></button>
<body style="background-color:#75ffc1;">
<h3 style="color:#ff6305;">Journal Vocuhers</h3>
<?php
Session_start();
...
$sql="Select * from journalvoucherno where branch='$_SESSION[branch]' and division='$_POST[division]'";
...
<div class="col-md-6">
Voucher no<input type="text" name="voucherno" value="<?php echo "JV/".$br."/".$dc."/".$vn?>">
</div>
</div><br>
<div class="row">
<div class="col-md-6">
...
<button type="submit" name="savejournal" formaction="savejournalvoucher.php">Save</button>
...
<button type="submit" name="view" formaction="viewjournalvoucher.php">view</button>
