...
try {
	$sql ="SELECT *FROM shipmentregister where  (docketno ='$_POST[docketno]'  or  exportername= '$_POST[exportername]' or  consigneename ='$_POST[consigneename]' or shiplinename='$_POST[shiplinename]' or overseasagentname='$_POST[overseasagentname]' or hblno='$_POST[hblno]' or containerno='$_POST[containerno]'   or origincountry='$_POST[origincountry]' or originport='$_POST[originport]' or loadcountry='$_POST[loadcountry]' or loadport='$_POST[loadport]' or dischargecountry='$_POST[dischargecountry]' or dischargeport='%_POST[dischargeport]' or destinationcountry='$_POST[destinationcountry]' or destinationport='$_POST[destinationport]')and branch ='$_SESSION[branch]' and fy='$_SESSION[fy]'";
	$res = $pdo->query($sql); 
	if ($res->rowCount() > 0) { 
		echo "<table id='sr'>"; 
		echo "<tr>";
...
$conn = new mysqli('localhost', 'root', '', 'exportsea') ;
 $result = $conn->query("SELECT *FROM shipmentregister where  (docketno ='$_POST[docketno]'  or  exportername= '$_POST[exportername]' or  consigneename ='$_POST[consigneename]' or shiplinename='$_POST[shiplinename]' or overseasagentname='$_POST[overseasagentname]' or hblno='$_POST[hblno]' or containerno='$_POST[containerno]' or origincountry='$_POST[origincountry]' or originport='$_POST[originport]' or loadcountry='$_POST[loadcountry]' or loadport='$_POST[loadport]' or dischargecountry='$_POST[dischargecountry]' or dischargeport='%_POST[dischargeport]' or destinationcountry='$_POST[destinationcountry]' or destinationport='$_POST[destinationport]')and branch ='$_SESSION[branch]' and fy='$_SESSION[fy]'");
