...
try {
	$sql = "SELECT *FROM shipmentregister where  consigneename= '$_POST[consigneename]'  and branch ='$_SESSION[branch]' and fy='$_SESSION[fy]'";
	$res = $pdo->query($sql); 
	if ($res->rowCount() > 0) { 
		echo "<table id='sr'>"; 
		echo "<tr>";
...
$conn = new mysqli('localhost', 'root', '', 'exportair') ;
 $result = $conn->query("SELECT *FROM shipmentregister where  where  consigneename= '$_POST[consigneename]'  and branch ='$_SESSION[branch]' and fy='$_SESSION[fy]'");
