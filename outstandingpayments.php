...
<h3 style="color:#ff6305;">outstanding payments</h3>
...
<button type="submit" name="saveout" formaction="saveoutp.php">Save</button>
<button type="submit" name="modify" formaction="updateoutp.php">modify</button>
<button type="submit" name="view" formaction="viewoutp.php">view</button>
</form>
</body>
<?head>
</html>