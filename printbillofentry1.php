...
$sql="Select * from iaedidet where jobno='$_POST[jobno]' and branch='$_POST[branch]'and fy='$_POST[fy]'";
...
$sql1="Select * From iaediinvoice where jobno='$_POST[jobno]' and branch='$_POST[branch]'and fy='$_POST[fy]'";
...
$pdf->Cell(10,1,$rows1['locno'].$rows1['locdate']);}
	...
	$pdf->line(5,$y,200,$y);
	$y=$y+5;
	$sql2="Select * from iaediitem where jobno='$_POST[jobno]' and branch='$_POST[branch]'and fy='$_POST[fy]'";
