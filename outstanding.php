...
<h3 style="color:#ff6305;">outstanding bills</h3>
...
<button type="submit" name="outstandingreceipts" formaction="outstandingreceipts.php">outstandingreceipts</button>
<button type="submit" name="outstandingpayments" formaction="outstandingpayments.php">outstandingpayments</button>
