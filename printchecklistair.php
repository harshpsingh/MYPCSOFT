...
while($rows=mysqli_fetch_array($result)){
	...
	$sql3="Select * from eaediitem where jobno='$_POST[jobno]' and branch='$_POST[branch]'and fy='$_POST[fy]'";
...
$pdf->AddPage();
$sql2="Select * from eaediinvoice where jobno='$_POST[jobno]' and branch='$_POST[branch]'and fy='$_POST[fy]'";
...
while($rows2=mysqli_fetch_array($result2)){
	...
	$pdf->Line(5,$y,200,$y);
	$y=$y+4;
	$sql3="Select * from eaediinvoice where jobno='$_POST[jobno]' and branch='$_POST[branch]'and fy='$_POST[fy]'";
$result3=mysqli_query($conn,$sql3);
while($rows3=mysqli_fetch_array($result3)){
...
while($rows3=mysqli_fetch_array($result3)){
	...
	$pdf->SetXY(120,$y);
	$pdf->Cell(10,1,$rows3['goodsdescription']);
	$y=$y+4;
	$pdf->SetXY(10,$y);
...
while($rows3=mysqli_fetch_array($result3)){
	...
	$sql4="Select Sum(dbkamount) as sumdbk from eaediitem where jobno='$_POST[jobno]' and branch='$_POST[branch]'and fy='$_POST[fy]'";
	...
	$sql19="Select * from eaedithirdparty where jobno='$_POST[jobno]' and branch='$_POST[branch]'and fy='$_POST[fy] '";
	...
	$y=$y+4;
	$sql20="Select * from eaedithirdparty where jobno='$_POST[jobno]' and branch='$_POST[branch]'and fy='$_POST[fy] '";
   ...
   $pdf->Line(5,$y,200,$y);
	...
	$sql5="Select * From eaedisupporting where jobno='$_POST[jobno]' and branch='$_POST[branch]'and fy='$_POST[fy]'";
...
while($rows=mysqli_fetch_array($result)){
	...
	$pdf->SetXY(60,$y);
	$pdf->Cell(10,1,'Total');
	$sql6="Select sum(fobinr) as sumfob from eaediitem where jobno='$_POST[jobno]' and branch='$_POST[branch]'and fy='$_POST[fy]'";
...
while($rows6=mysqli_fetch_array($result6)){
	...
	$sql6="Select sum(totalpmv) as sumpmv from eaediitem where jobno='$_POST[jobno]' and branch='$_POST[branch]'and fy='$_POST[fy]'";
$result6=mysqli_query($conn,$sql6);
while($rows6=mysqli_fetch_array($result6)){
	$pdf->SetFont('Arial','',10);
	$pdf->SetXY(120,$y);
