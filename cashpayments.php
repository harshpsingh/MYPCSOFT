...
<h3 style="color:#ff6305;">Cash Payments</h3>
<?php
Session_start();
...
$sql="Select * from cashpaymentno where branch='$_SESSION[branch]' and division='$_POST[division]'";
...
<input type="hidden" name="vn" value="<?php echo $vn?>"><br>
<div class="row">
<div class="col-md-3">
...
<button type="submit" name="savecashpayment" formaction="savecashpayment.php">Save</button>
...
<button type="submit" name="view" formaction="viewcashpayment.php">view</button>
