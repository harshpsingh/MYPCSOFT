...
<button type="submit"  class="btn-primary" name="Saveitem" formaction="saveesedithirdparty.php">Savethirdparty</button>
<button type="submit"  class="btn-primary" name="profile" formaction="esedidet.php">ediprofile</button><br>

</form>
<iframe src="viewesedithirdparty.php" width="800"height="300" style="background-color:white;" ></iframe>
</body>
</head>
