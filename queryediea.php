...
<a href="eaediprofile.php">edi profile</a>
<?php
session_start();
...
try{
    $conn2 = new PDO("mysql:host=$servername;dbname=exportair", $username, $password);
...
<button type="submit" name="create" formaction="eaedidet.php">eaedidet</button>
