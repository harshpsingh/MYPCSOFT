...
<div class="col-md-3">
<label>job no</label><input type="text" name="jobno" readonly value="<?php echo $_POST['jobno'];?>">
</div>
<div class="col-md-3">
<label>user name</label><input type="text" name="username" readonly value="<?php echo $_SESSION['username'];?>">
</div>
<div class="col-md-3">
...
<div class="col-md-3">
<label>Invoice srno</label><input type="text" name="invoicesrno">
</div>
<div class="col-md-3">
...
<div class="col-md-3">
<label>Invoice value</label><input type="text" name="invoicevalue" id="invoicevalue">
</div>
</div><br>
<div class="row" style="position:relative; left:5;">
<div class="col-md-6" >
...
<div class="row"style="position:relative; left:5;">
<div class="col-md-6">
<label>Contract no</label><input type="text" name="contractno">
</div>
<div class="col-md-6">
...
<button type="submit" name="saveediinvoice"  class="btn-success" formaction="saveediinvoice.php" style="position: relative;left: 20px">save</button>
