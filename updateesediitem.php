...
or die ('Cannot connect to db');
    ...
    $result = $conn->query("select distinct invoicesrno from esediitem where jobno='$_POST[jobno]' and branch='$_SESSION[branch]' and fy='$_SESSION[fy]'");
    
    echo "<html>";
    echo "<body>";
    echo "<select name='invoicesrno' id='invoicesrno' onChange='getitemno(this.value);'>";
	...
	<button type="submit" name="update"  formaction="updateeseditem1.php">updateitemdetails</button>
</form>
</body>
</head>
</html>
