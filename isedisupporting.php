...
or die ('Cannot connect to db');
    ...
    $result = $conn->query("select * from isediinvoice where jobno='$_POST[jobno]'");
...
<button type="submit" name="Savesupporting" formaction="saveissupportingdetails.php">Savisupporting</button>
