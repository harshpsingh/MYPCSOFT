...
or die ('Cannot connect to db');
    ...
    $result = $conn->query("select * from eaediitem where jobno='$_POST[jobno]' and branch='$_SESSION[branch]' and fy='$_SESSION[fy]'");
...
<button type="submit" name="Savesupporting" formaction="saveeasupportingdetails.php">Savesupporting</button>
