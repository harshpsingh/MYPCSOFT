...
<title> Modify Exporter Details</title>
...
Exportername<input type="text" name="exportername" size="30" value="<?php echo $exportername?>">
...
Gstinno<input type="text" name="gstin" value="<?php echo $gstinno?>"><br>
...
<button type="submit" name="update" formaction="modifyexporter.php">Update</button>
</form>
</body>
</head>
</html>