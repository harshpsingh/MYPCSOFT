...
while($rowsa=mysqli_fetch_array($resulta)){
	...
	$pdf->SetFont('Arial','',10);
	$pdf->SetXY(30,90);
	$pdf->Cell(10,1,$rows['gststatename']);
	$pdf->SetFont('Arial','B',10);
	$pdf->SetXY(10,94);
	$pdf->Cell(10,1,'Code:');
	$pdf->SetFont('Arial','',10);
	$pdf->SetXY(30,94);
	$pdf->Cell(10,1,$rows['gststatecode']);
	$pdf->SetFont('Arial','B',10);
	$pdf->SetXY(10,102);
	...
	$sql1="Select * From iaserviceinvoice where docketno='$_POST[docketno]' and branch='$_POST[branch]'and fy='$_POST[fy]'";
...
$sql2="Select * From iainvoicecharge where docketno='$_POST[docketno]' and branch='$_POST[branch]'and fy='$_POST[fy]'";
...
$sql3="Select sum(amount) as sumamount,sum(amount-discount) as sumtaxamount,sum(cgstrate*(amount-discount)) as sumcgstamount,sum(sgstrate*(amount-discount)) as sumsgstamount,sum(igstrate*(amount-discount)) as sumigstamount from iainvoicecharge where docketno='$_POST[docketno]' and branch='$_POST[branch]'and fy='$_POST[fy]'";
